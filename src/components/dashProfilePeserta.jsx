...
import { getNimFromLocal, getRoleFromLocal } from '@/utils/localRole';
...
export default function DashboardProfile() {
  ...
  const [nims, setNim] = useState(null);
  const [roles, setRole] = useState(null);

  useEffect(() => {
    const storedNim = getNimFromLocal();
    setNim(storedNim);
    const storedRole = getRoleFromLocal();
    setRole(storedRole);
  }, []);

  console.log('NIM dari localStorage di DashboardProfile:', nims);
  console.log('Role dari localStorage di DashboardProfile:', roles);
