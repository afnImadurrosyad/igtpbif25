...
// Define all navigation items with role-based access (outside component to prevent recreation)
const allNavItems = [
  {
    id: "dashboard",
    title: "Dashboard",
  ...
  },
  {
    ...
    roles: ["user", "daplok", "mentor", "admin"],
  },
  {
    id: "peserta",
    title: "Peserta",
...
export default function NavbarDash({
  ...
  const navItems = useMemo(() => {
    return role ? allNavItems.filter((item) => item.roles.includes(role)) : [];
  }, [role]);
  ...
  const handleNavClick = useCallback(
    ...
    [isMobile, setIsMobileMenuOpen, onNavItemClick]
  );
  ...
  }, [isMobile, setIsMobileMenuOpen, router]);
