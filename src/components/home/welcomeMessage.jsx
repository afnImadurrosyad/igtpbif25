    ...
    const refs = [
      {
        ...
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1 },
      },
      {
        el: welcomeText.current,
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1 },
      },
      {
        el: btnAbout.current,
        anim: { opacity: 0, x: -50 },
        opts: { opacity: 1, x: 0, duration: 1 },
      },
      {
        el: btnFindGroup.current,
        anim: { opacity: 0, y: 100, scale: 0.8 },
        opts: {
          opacity: 1,
          y: 0,
          scale: 1,
      ...
      {
        el: imgLogo.current,
        anim: { opacity: 0, scale: 0, rotation: 360 },
        opts: {
          opacity: 1,
          scale: 1,
          rotation: 0,
      ...
      {
        el: whatIgttpb.current,
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1 },
      },
      {
        el: igtTpbDesc.current,
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1, delay: 0.2 },
      },
      {
        el: visiIgttpb.current,
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1, delay: 0.4 },
      },
      {
        el: misiIgttpb.current,
        anim: { opacity: 0, y: 50 },
        opts: { opacity: 1, y: 0, duration: 1, delay: 0.6 },
      },
    ];
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#DCE2B7] via-[#E8EDCC] to-[#DCE2B7] p-4 sm:p-8 lg:p-48 font-poppins pb-13'>
      ...
      <div id='aboutIGTTPB' style={{ scrollMarginTop: '100px' }}>
        ...
        <h1
          ref={whatIgttpb}
          className='text-3xl lg:text-5xl font-extrabold text-center bg-gradient-to-r from-[#5a5a3d] to-[#5a5a3d] bg-clip-text text-transparent'>
          Apa itu IGTTPB?
        </h1>
        <p
          ref={igtTpbDesc}
          className='text-md lg:text-xl text-center max-w-4xl mx-auto mt-6 text-[#5a5a3d] leading-relaxed'>
        ...
        <div className='max-w-7xl mx-auto bg-[#F7F1E7] mt-10 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 backdrop-blur-sm border border-white/20'>
          <div className='grid grid-cols-1 lg:grid-cols-2 items-start gap-8 p-10 text-[#5a5a3d]'>
            <div
              ref={visiIgttpb}
              className='bg-white/40 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] border border-[#5a5a3d]/10'>
